...
1. Visit the [Chrome Web Store listing](https://chromewebstore.google.com/detail/notion-turbo-—-long-chat/fjkndmidlkigmfdobibghmhlpkpecabe).
...
4. Click **Load unpacked** and select the extension folder (notion-turbo v1.x.x).
...
The extension runs only on the Notion app page (`app.notion.com`) and does nothing on any other site.
